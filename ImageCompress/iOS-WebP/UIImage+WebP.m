...
+ (NSData *)imageToWebP:(UIImage *)image quality:(CGFloat)quality alpha:(CGFloat)alpha
{
  NSParameterAssert(image != nil);
  NSParameterAssert(quality >= 0.0f && quality <= 100.0f);
  return [self convertToWebP:image quality:quality alpha:alpha preset:WEBP_PRESET_DEFAULT configBlock:nil error:nil];
}
